export const projects = [
    {"img": "./projectImgs/weatherAppImg.png",
    "title": "Weather App",
    "description": "A simple weather app that allows users to transition between C° and F°." ,
    "tech": "React | OpenWeather API",
    "url": "https://taylorhartsfield.github.io/reactweatherapp"},

    {"img": "./projectImgs/trafficLightImg.png",
    "title": "Traffic Light",
    "description": "A traffic light build with React Hooks.",
    "tech": "React",
    "url": "https://taylorhartsfield.github.io/trafficlight"},

    {"img": ".projectsImgs/playbuildProImg.png",
    "title": "PlayBuild Pro",
    "description": "A full stack web application that allows users register a show and create a virtual\
